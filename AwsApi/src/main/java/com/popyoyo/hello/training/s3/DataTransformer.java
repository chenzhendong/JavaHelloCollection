package com.popyoyo.hello.training.s3;
...
public class DataTransformer {
    ...
    public static final String INPUT_BUCKET_NAME = "input-123";

    // STUDENT TODO: Update output bucket name to a unique bucket name.
    public static final String OUTPUT_BUCKET_NAME = "output-123";

    public static final Region BUCKET_REGION = DataTransformerUtils.getRegion();
    ...
    private static void init() throws Exception {
        ...
        DataTransformerUtils.setup(credentials, s3ForStudentBuckets);
    }
